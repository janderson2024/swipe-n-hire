  ...
  return (
    ...
    <main className="px-4">
      ...
      <div className="justify-center">
        ...
        <div>
          <h2 className="text-l block text-center mt-2">1 of 20 Applications</h2>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-4">
        ...
        <div className="flex h-96 w-4/5 bg-gray-100 rounded-md">
        </div>
        <div className="flex items-center p-4">
          <div>
      ...
      <div className="flex justify-center mt-4">
        <h2 className="text-l block text-center font-semibold text-purple-700">View Applicant Information</h2>
      </div>
