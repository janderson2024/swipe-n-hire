export default function TermsModal() {
  return (
    <>
      ...
      <div>
        <p>
          By accessing and using this website Swipe-n-Hire, you agree to comply
        ...
        <p>
          <strong>User Conduct:</strong> You agree to use this website only for
          lawful purposes and in a manner that does not infringe upon the rights
          of, or restrict or inhibit the use and enjoyment of, others.
        </p>
        <p>
          <strong>Intellectual Property:</strong> All content on this website,
          including text, images, graphics, and logos, is protected by copyright
        ...
        <p>
          ...
          regarding its accuracy, reliability, or availability.
        </p>
        <p>
        ...
        <p>
          ...
          these websites and are not responsible for their content or practices.{" "}
        </p>
        <p>
          <strong>Changes to Terms:</strong> We reserve the right to modify
          these terms at any time. Your continued use of the website after such
